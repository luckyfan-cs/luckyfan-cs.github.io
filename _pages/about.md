...
<details class="collapsible-section recent-works">
  ...
  <ul>
    <li>[KDD] Zherui Yang, <strong>Fan Liu</strong>, Yansong Ning and Hao Liu*. EvoDS: Self-Evolving Autonomous Data Science Agent with Capability Learning and Context Management. In Proceedings of the 32nd SIGKDD Conference on Knowledge Discovery and Data Mining, Jeju, South Korea, 2026. <a href="https://raymondhliu.github.io/publications/">[Paper]</a>, <a href="https://arxiv.org/abs/2606.03841">[arXiv]</a>, <a href="https://github.com/usail-hkust/EvoDS">[Code]</a> <strong>(CCF A)</strong></li>
