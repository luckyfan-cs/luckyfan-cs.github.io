...
<details class="collapsible-section recent-works">
  ...
  <ul>
    <li>[EMNLP Findings] <strong><a href="https://openreview.net/profile?id=~Fan_Liu5">Fan Liu</a></strong>, <a href="https://openreview.net/profile?id=~Tianyu_Pang1">Tianyu Pang</a>, <a href="https://openreview.net/profile?id=~Chao_Du1">Chao Du</a>, and <a href="https://openreview.net/profile?id=~Hao_Liu17">Hao Liu</a>. <a href="https://openreview.net/forum?id=sqhwxVmLQB">DSFlow: Evolutionary Workflow Optimization for Generalizable LLM-Based Data Science Automation</a>. EMNLP 2026 Findings. <a href="https://openreview.net/group?id=EMNLP/2026/Conference#tab-findings">[Findings]</a></li>
